...
<!-- For instance, in another classic paper from the same time, @nosofsky1986attention argued that category representations could be constructed by storing each observed exemplar and generalizing from them by applying the exponential law separately to each item.  -->

# Distinguishing theoretical and empirical strength
